...
-- no repetition and no multivalued cols
order_id int primary key,
order_date date,
customer_id int,
customer_name varchar(50),
...
-- move order to reference just customer_id
...
create table Order_Items_3NF like OrderItems_2NF;
...
insert into Order_Items_3NF select * from OrderItems_2NF;